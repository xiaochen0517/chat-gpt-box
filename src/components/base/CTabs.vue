...
const activeClass = ref("border-gray-400 bg-gray-200 hover:bg-gray-300 hover:text-gray-900 active:bg-gray-400 dark:border-gray-600 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:active:bg-gray-600 text-gray-500 dark:text-gray-500");
...
const closeActiveClass = ref("hover:bg-gray-400 dark:hover:bg-gray-600");
const closeInactiveClass = ref("hover:bg-gray-200 dark:hover:bg-gray-700");
</script>
